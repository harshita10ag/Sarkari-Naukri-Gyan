...
<html>
<head>
<link rel="canonical" href="https://www.sarkarinaukrigyan.com/latestjob.php">
<title>Rojgar Samachar | Latest Central Govt / Sarkari Jobs Alert
</title>
<meta name="description" content="Get free notification of all Government Jobs across UP, Bihar, All India Recruitment with full Vacancy details. ✔ Free Job Alert ✔ Frequently Updated" />
<meta name="keywords" content="Recruitment, Jobs Advertisement, Latest Recruitment, Notifications, Sarkari Job, Govt vacnacy,  Rojgar Result" />
...
<!-- <script async src="https://www.googletagmanager.com/gtag/js?id=UA-177216254-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-177216254-2');
</script> -->

<script type="67222cd2e26899db6ed5b90d-text/javascript">(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
...
"position": 1,
"name": "Home",
"item": "https://www.sarkarinaukrigyan.com/index.php"
},{
...
<ul class="breadcrumb">
<span class="bread">You are here > <a href="index.php">Home</a> > Latest Job </span>
</ul>
</div>
</div>
<br><br>
<div align="center" class="adv">
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js" type="67222cd2e26899db6ed5b90d-text/javascript"></script>
...
<script type="67222cd2e26899db6ed5b90d-text/javascript">
(adsbygoogle = window.adsbygoogle || []).push({});
</script>
</div>
<br><br>
<div align="center"><font size="+3"><b><a href="https://sarkarinaukrigyan.com/">Click Here to Visit SarkariNaukriGyan.com Home Page</a></b></font></div>
<table width="75%" align="center">
<tr>
<td style="width:50%; background-color:#ffffff; border:1px; border-color:#000000; border-style:solid" valign="top">
<h1 align="center" id="heading">Latest Jobs</h1>
<div id="post">
	<?php 
  $query="select * from jobs order by id desc";
  $result = mysqli_query($conn,$query);
  while($row = mysqli_fetch_assoc($result)) { ?>
    <ul><li><a title="<?php echo $row['postname'];?>" href="jobdetail.php?id=<?php echo $row['id'].'&'.str_replace(' ', '-', $row['postname']);?> " target=_blank><?php echo $row['postname'];?></a> Last Date : <?php echo $row['lastdate'];?></li></ul>
  <?php }
  ?>
</div>
</td>
...
<div align="left">
<center><script type="67222cd2e26899db6ed5b90d-text/javascript" src="https://pagead2.googlesyndication.com/pagead/show_ads.js">
</script></center>
<script type="67222cd2e26899db6ed5b90d-text/javascript">
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="67222cd2e26899db6ed5b90d-|49" defer=""></script></body>
</html>