...
<html>
<head>
<link rel="canonical" href="https://www.sarkarinaukrigyan.com/answerkey.php">
<title>Sarkari Results Latest Answer Key | Question Paper 2020</title>
<meta name="description" content="Download Latest Recruitment Exam Answer Key, Question Paper, Online Ojection 2020, Frequently Update" />
<meta name="keywords" content="UPPSC Answer Key, SSC Answer Key, UPSSSC Answer Key 2020, All Admission Answer Key, Question Paper Download " />
...
<script type="47998ba60499c132d9f85007-text/javascript">(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
...
"position": 2,
"name": "Answer Key",
"item": "https://www.sarkarinaukrigyan.com/answerkey.php"
}]
...
<ul class="breadcrumb">
<span class="bread">You are here > <a href="index.php">Home</a> > Answer Key </span>
</ul>
</div>
</div>
<br><br>
<div align="center" class="adv">
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js" type="47998ba60499c132d9f85007-text/javascript"></script>
...
<script type="47998ba60499c132d9f85007-text/javascript">
...
<h1 align="center" id="heading">Answer Key</h1>
<div id="post">
	<?php 
  $query="select * from answerkey order by id desc";
  $result = mysqli_query($conn,$query);
  while($row = mysqli_fetch_assoc($result)) { 
  	$qry=mysqli_query($conn,"select * from jobs where id=".$row['jobid']);
  	$like=mysqli_fetch_object($qry);
  	$postname= $like->postname;
  	 $post=str_replace("Online Form","Answer Key",$postname);
  	?>
    <ul><li><a title="<?php echo $post;?>" href="jobdetail.php?id=<?php echo $like->id.'&'.str_replace(' ', '-', $post);;?> " target=_blank><?php echo $post;?></a> </li></ul>
  <?php } ?>
</div>
...
<div align="left">
<center><script type="47998ba60499c132d9f85007-text/javascript" src="https://pagead2.googlesyndication.com/pagead/show_ads.js">
</script></center>
<script type="47998ba60499c132d9f85007-text/javascript">
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="47998ba60499c132d9f85007-|49" defer=""></script></body>
</html>